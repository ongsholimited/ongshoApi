 ...
 @section('content')
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
                ...
                <div class="row">
                  ...
                  <div class="col-md-8 mr-auto ml-auto">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="name" placeholder="Enter Chapter Name">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary" onclick="formRequest()" id="submitBtn">Save</button>
            </div>
          </div>
        </div>
      </div>
  ...
  @include('institute.chapter.internal-assets.js.script')
  @endsection