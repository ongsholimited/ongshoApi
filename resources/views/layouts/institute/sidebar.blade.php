    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{URL::to('/institute/category')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{URL::to('/institute/course')}}" class="nav-link">
              <i class="nav-icon fas fa-donate"></i>
              <p>
                Manage Course
              </p>
          ...
          <li class="nav-item">
            <a href="{{URL::to('institute/chapter')}}" class="nav-link">
              <i class="nav-icon fas fa-donate"></i>
              <p>
                Manage Chapter
              </p>
          ...
          <li class="nav-item">
            <a href="{{URL::to('/institute/content')}}" class="nav-link">
              <i class="nav-icon fas fa-donate"></i>
              <p>
                Manage Content
              </p>
