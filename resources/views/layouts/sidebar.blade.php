...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ URL::to('/home') }}" class="brand-link bg-light">
        <img src="{{ asset('storage/adminlte/dist/img/logo.png') }}" alt="Ongsho"
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="{{ URL::to('/institute/dashboard') }}" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="{{ URL::to('/sms/dashboard') }}" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="{{ URL::to('/news/dashboard') }}" class="nav-link">
                    ...
                    <ul class="nav nav-treeview ml-1">
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview ml-2">
                                <li class="nav-item">
                                    <a href="{{ URL::to('setting/role') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create Role</p>
                                    </a>
                                </li>
