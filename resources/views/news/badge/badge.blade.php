 ...
 @section('content')
                ...
                <div class="row">
                  <div class="col-md-8 mr-auto ml-auto">
                    <div class="form-group">
                      ...
                      <select name="" id="user" class="form-control"></select>
                  ...
                  <div class="col-md-8 mr-auto ml-auto">
                    <div class="form-group">
                      <label for="recipient-name" class="col-form-label">Badge Name:</label>
                      <select name="" id="badge_name" class="form-control">
                        <option value="">--select--</option>
                        <option value="news_verified">News Verified</option>
                      </select>
                      <div class="invalid-feedback" id="badge_name_msg">
  ...
  @include('news.badge.internal-assets.js.script')
  @endsection