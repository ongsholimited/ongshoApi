                             ...
                             <div class="row">
                                 ...
                                 <div class="col-md-10 mr-auto ml-auto">
                                     <div class="form-group">
                                         ...
                                         {{ URL::to('/api/news') }}/<input type="text" class="form-control-sm"
                                             id="slug" placeholder="Write Slug" value="{{ $post->slug }}">
                         ...
                         <div class="col-12 col-md-3">
                             <div class="form-group">
                                 ...
                                 <img class="img-fluid rounded"
                                     src="{{ asset('storage/media/images/news/' . $post->feature_image) }}" alt=""
                             ...
                             <div class="input-group">
                                 ...
                                 <div class="input-group-append">
                                     <button class="btn btn-outline-secondary" id="add_author"
                                         type="button">Add</button>
                                 </div>

                             </div>
                             <div class="d-block" id='all_users'>
                             ...
                             <div class="form-group">
                                 ...
                                 <select class="form-control" name="status" id="status">
                                     ...
                                     @foreach ($status_arr as $stats_key => $stats)
                                         <option {{ $stats == $post->status ? 'selected' : '' }}
                                             value="{{ $stats }}">{{ ucfirst(str_replace('_', ' ', $stats_key)) }}
                                         </option>
                                     @endforeach
                                 </select>
                                 <div class="invalid-feedback" id="focus_keyword_msg">
                             ...
                             <div class="form-group">
                                 ...
                                 <select class="form-control" name="post_type" id="post_type">
                                     ...
                                     @foreach ($post_type as $stats_key => $stats)
                                         <option {{ $stats == $post->post_type ? 'selected' : '' }}
                                             value="{{ $stats }}">{{ ucfirst(str_replace('_', ' ', $stats_key)) }}
                                         </option>
                                     @endforeach
                                 </select>
