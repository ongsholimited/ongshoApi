                ...
                <div class="row">
                  ...
                  <div class="col-md-10 mr-auto ml-auto">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="title" placeholder="Write title" value="{{$post->title}}">
                  ...
                  <div class="col-md-10 mr-auto ml-auto">
                    <div class="form-group">
                      ...
                      <input class="d-block"  id="focus_keyword" placeholder="Focus Keyword" value="{{$post->focus_keyword}}">
